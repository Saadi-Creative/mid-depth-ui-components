...
export default function EventRegistration() {
  ...
  return (
    <div
      className={`min-h-screen py-12 px-6 flex items-center justify-center relative overflow-hidden transition-colors duration-500 ${activeVariant.canvasClass} font-secondary`}
    >
